...
CREATE DATABASE IF NOT EXISTS `allindia_services` 
CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

-- Step 2: Use the database
USE `allindia_services`;

-- Step 3: Create user if it doesn't exist (optional - for production)
-- Note: For local development, you can use root user
-- CREATE USER IF NOT EXISTS 'allindia_seruser'@'localhost' IDENTIFIED BY 'allitr@#PASss';
-- GRANT ALL PRIVILEGES ON `allindia_services`.* TO 'allindia_seruser'@'localhost';
-- FLUSH PRIVILEGES;
...
INSERT INTO `users` (`FirstName`, `LastName`, `Email`, `Mobile`, `Password`, `Platform`, `Version`) 
VALUES ('Test', 'User', 'test@example.com', '9876543210', 'test123', 'web', '1.0')
