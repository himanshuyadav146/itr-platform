-- ============================================
-- ITR API Database Setup Script for cPanel
-- ============================================
-- IMPORTANT: Use this file ONLY after creating database and user in cPanel
-- 
-- Steps:
-- 1. Create database in cPanel → MySQL Databases
-- 2. Create database user in cPanel → MySQL Databases
-- 3. Add user to database with ALL PRIVILEGES
-- 4. Then run this SQL file in phpMyAdmin
-- ============================================

-- IMPORTANT: Replace 'your_cpanel_username_itr_services' with your actual database name
-- The database name in cPanel will be: cpanelusername_itr_services
