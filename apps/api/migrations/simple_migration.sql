-- ============================================
-- Simple Package Management Migration
-- Run all commands in one go
-- Date: 2026-01-17
-- ============================================

-- STEP 1: Add columns to itr_packages
ALTER TABLE `itr_packages` 
ADD COLUMN `turnover` varchar(100) DEFAULT NULL COMMENT 'Turnover range',
ADD COLUMN `icon` varchar(100) DEFAULT NULL COMMENT 'Icon identifier',
ADD COLUMN `color` varchar(50) DEFAULT NULL COMMENT 'Color code';

-- STEP 2: Add package_id to personal_details
ALTER TABLE `personal_details` 
ADD COLUMN `package_id` int(11) DEFAULT NULL COMMENT 'Selected ITR package';
...
SELECT id, packagename, price, turnover FROM itr_packages ORDER BY id;
